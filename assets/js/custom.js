...
$(document).ready(function () {
    ...
    $('.selectedId2').change(function () {
        var check = ($('.selectedId2').filter(":checked").length == $('.selectedId2').length);
        $('#selectall2').prop("checked", check);
    });
    ...
    $('.selectedId3').change(function () {
        var check = ($('.selectedId3').filter(":checked").length == $('.selectedId3').length);
        $('#selectall3').prop("checked", check);
    });
    ...
    $('.selectedId4').change(function () {
        var check = ($('.selectedId4').filter(":checked").length == $('.selectedId4').length);
        $('#selectall4').prop("checked", check);
    });
